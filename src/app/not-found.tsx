...
// import SocialItems from '@/components-ysly/ui/social-shares';
  ...
  return (
    <div className="flex min-h-screen flex-col bg-[#F8FAFC]">
      <div className="sticky top-0 z-40 flex justify-center py-5 backdrop-blur-lg lg:backdrop-blur-none xl:py-10">
        <Link href="/" className='font-olga text-4xl font-medium'>
          APP Name
          {/* <Image
            src={siteConfig.logo}
        ...
        <div className="mx-auto text-center">
          ...
          <Link href={'/'}>
            <Button
              ...
              size="xl"
              color="primary"
              className="mt-8 h-10 px-4 xl:h-10 xl:px-6 text-white"
            >
