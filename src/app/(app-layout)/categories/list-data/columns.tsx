  ...
  useTableParams,
}: Columns) => [
    {
      title: <HeaderCell
        ...
        className='ml-3'
        sortable={true}
        isShowIcon={useTableParams.sortBy === 'categoryName'}
        ascending={
          useTableParams?.sortOrder === 'asc' && useTableParams.sortBy === 'categoryName'
        }
      />,
      dataIndex: '',
      key: '',
      width: 180,
      onHeaderCell: () => {
        const sortInfo = (useTableParams.sortOrder === 'desc' && useTableParams?.sortBy === 'categoryName') ? 'asc' : 'desc'
        return onHeaderCellClick({ key: 'categoryName', value: sortInfo, skip: 0 })
      },
      render: (info: any) => {
        return (
    ...
    },
    {
      title: <HeaderCell
        ...
        className='ml-3'
        sortable={true}
        isShowIcon={useTableParams.sortBy === 'categoryDescription'}
        ascending={
          useTableParams?.sortOrder === 'asc' && useTableParams.sortBy === 'categoryDescription'
        }
      />,
      dataIndex: '',
      key: '',
      width: 180,
      onHeaderCell: () => {
        const sortInfo = (useTableParams.sortOrder === 'desc' && useTableParams?.sortBy === 'categoryDescription') ? 'asc' : 'desc'
        return onHeaderCellClick({ key: 'categoryDescription', value: sortInfo, skip: 0 })
      },
      render: (info: any) => {
        return (
          <div className='flex ml-3 text-md text-gray-900 cursor-pointer break-all'>
