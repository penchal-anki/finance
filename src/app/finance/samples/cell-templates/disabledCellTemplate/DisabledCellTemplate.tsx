...
export const DisabledCellTemplate: CellTemplate<DisabledCell> = {
    ...
    render(cell: Compatible<DisabledCell>): React.ReactNode {
        return <div className={cell.className}>{cell.text || (cell.value !== 0 && cell.value)}</div>
    },
}

export const getDisabledCell = (value: string | number, style?: CellStyle, className?: string): DisabledCell => ({
    type: 'disabled',
