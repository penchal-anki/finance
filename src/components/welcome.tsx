...
export default function WelcomePage() {
  const { setAppContextData } = useContext<any>(AppContext);
  ...
  return (
    <div className="flex grow items-center mt-10">
      <div className="mx-auto flex w-full flex-col-reverse items-center justify-between text-center lg:flex-row lg:gap-5 lg:text-start">
        <div>
          <Title
            as="h2"
          ...
          <div className="mt-8 flex flex-col justify-center gap-4 lg:flex-row lg:justify-start xl:gap-6">
            <Button
              color="primary"
              size="md"
              className="h-10 px-4 xl:h-10 xl:px-4"
        ...
        <div className="relative">
          <Image
            src={LaptopImg}
            alt="coming-soon"
            className="aspect-[632/630] max-w-[256px] sm:max-w-xs"
          />
          <Image
            src={MobileImg}
            alt="coming-soon"
